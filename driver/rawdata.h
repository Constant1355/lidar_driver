...
namespace velodyne_rawdata
{
  ...
  public:
     ...
     */
    int setup(std::string calibration_file, double max_range_, double min_range_);

    void unpack(const uint8_t* pkt, const std::array<float,16> trans_matrix,
